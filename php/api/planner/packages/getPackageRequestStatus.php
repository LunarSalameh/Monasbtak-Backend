...
try {
    ...
    if ($planner_id) {
        $sql = "SELECT id, name, description, price, image, location, subCat_name, category_id, status, venueDetails FROM packeges WHERE planner_id = :planner_id AND status != 'Accepted'"; 
