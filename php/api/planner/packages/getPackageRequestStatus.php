...
try {
    ...
    if ($planner_id) {
        $sql = "SELECT id, name, description, price, image, location, subCat_name, category_id, status FROM packeges WHERE planner_id = :planner_id AND status != 'Accepted' AND IsDeleted = 0"; 
